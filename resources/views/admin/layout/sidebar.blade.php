    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="admin/danhmuc/danhsach">Danh sách danh mục</a></li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="editors">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="admin/sanpham/danhsach">Danh sách sản phẩm</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-advanced">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="admin/slide/danhsach">Danh sách slide</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="admin/noisanxuat/them"> Thêm nơi sản xuất </a></li>
                    <li class="nav-item"> <a class="nav-link" href="admin/noisanxuat/danhsach"> Danh sách nơi sản xuất </a></li>
                </ul>
            </div>
        </li>
    </ul>
