                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8 text-center">
                            ...
                            <p class="title-detail">Nếu bạn cần tư vấn về sản phẩm hoặc có những đóng góp cho chúng tôi.
                                Xin liên hệ với chúng tôi bằng các điền các thông tin dưới đây.Xin cảm ơn!</p>
                ...
                <div class="contact-form">
                    ...
                    <form id="contact-form" action="lienhe" method="post">
                        ...
                        <div class="row">
                            ...
                            @else
                                <div class="form-group au-form" style="display: flex;justify-content: center">
                                    <span style="color: red">Bạn vui lòng <a href="tai-khoan/index">đăng nhập</a> để có thể gửi liên hệ với chúng tôi!</span>
                                </div>
                            @endif
                        </div>
                    </form>
