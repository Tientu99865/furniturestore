                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="au-form-body">
                            ...
                            <table class="checkout-bill">
                                ...
                                @foreach($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="total" value="{{$product->price*$product->qty}}"
                                                   hidden>
                            ...
                            @if(Auth::guard('customers')->user()->active == 0)
                                <span class="text-danger">Tài khoản chưa được xác nhận nên không thể đặt hàng. Vui lòng kiểm tra email và xác nhận tài khoản</span>
                            @else
                                <input type="submit" name="submit" class="process-button m-t-50 float-right"
                                       value="Đặt Hàng">
                            @endif
                        </div>
